...
'''python3 evaluate.py --model snli/SaveModel/Gumble_drop_0.1_test_Glove_840B_batch_norm_leaf_rnn/model-5.80-0.4737-0.8444.pkl --data snli/Data/val.pkl --word-dim 300 --hidden-dim 300 --clf-hidden-dim 1024 --clf-num-layers 1 --leaf-rnn --batchnorm --dropout 0.1 --device cuda:0 --batch-size 64
'''
